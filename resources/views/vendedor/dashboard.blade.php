<x-guest-layout>
                            ...
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}" x-data>
                                        @csrf
                                        <x-dropdown-link href="{{ route('logout') }}" @click.prevent="$root.submit();">{{ __('Cerrar') }}</x-dropdown-link>
                                    </form>
                                </x-slot>
                            </x-dropdown>
                        </div>
    ...
    <div class="container mx-auto mt-12 p-8 bg-white rounded-lg shadow-lg">
        <h1 class="text-4xl font-bold text-center text-gray-800">Vendedor</h1>
        ...
        <div class="mt-8">
            ...
            <ul class="mt-2 space-y-3">
                ...
                <li>
                    <a href="{{ route('vendedor.products.create') }}" class="block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 transition duration-200 text-center">
                        Agregar Producto
                    </a>
                </li>
            </ul>
